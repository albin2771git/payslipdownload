...
class ApiTable extends StatefulWidget {
  const ApiTable({super.key});

  @override
  State<ApiTable> createState() => _ApiTableState();
}
...
class _ApiTableState extends State<ApiTable> {
  ...
  // List<ApiModel> num = List.generate(3, (index) => ApiModel());
                          ...
                          children: [
                            Flexible(
                              ...
                              child:
                                ...
                                // ...datafetch.map((e) {
                                //   var index = datafetch.indexOf(e);
                                //   print(".....${index}");
                                //   return TableRow(children: [
                                //     inside(e["amountDetails"][1]
                                //             ["amountInDetail"][index]
                                //         ["amountLabel"]),
                                //     //   inside("insideValue"),
                                //     Amount("43600"),
                                //     inside(e["amountDetails"][0]
                                //             ["amountInDetail"][index]
                                //         ["amountLabel"]),
                                //     Amount("43600"),
                                //   ]);
                                // }),
                                ...earningsList.map((e) {
                                  var i = earningsList.indexOf(e);
                                  return TableRow(children: [
                                    inside(e["amountLabel"]),
                                    //   inside("insideValue"),
                                    Amount("43600"),
                                    inside(e["amountLabel"]),
                                    Amount("43600")
